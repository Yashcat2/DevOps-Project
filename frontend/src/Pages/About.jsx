    ...
    <div className='about'>
        <div className="about-contaier">
            ...
            <div className="about-right">
                <h2>About Me</h2>
                <p>Hello, I'm , a third-year undergraduate student pursuing a Bachelor of Science in Engineering at the Faculty of Engineering, University of Ruhuna. My major is in Computer Engineering, where I am deeply immersed in both theoretical and practical aspects of the field.</p>
